...
//if session exit, user either needs to sign-in or they need to sign-up
...
//Login progress start, if user presses the sign-in button
if (isset($_POST['signIn'])) {
    if (empty($_POST['email']) || empty($_POST['password'])) {
        echo "Email & Password should not be empty";
    }
    else
    {
        $email = $_POST['email'];
            ...
            <div class="rlform-box-inner">
                <form method="post">
                    ...
                    <div class="text-foot">
                        ...
                        <br><br>
                        Return to home page <a href="index.php">HOME</a>
                    </div>
                </form>
            </div>
        </div>
